...
class ListViewContentHandler extends xj.mobile.common.ListViewContentHandler { 
  ...
  void initVar() { 
	...
	listDataVarType = (hasEntity ? 'NSMutableArray' : 'NSArray')

	info "[ios.ListViewContentHandler] hasEntity=${hasEntity} dataVarName=${dataVarName} listDataVarType=${listDataVarType}"
  }
