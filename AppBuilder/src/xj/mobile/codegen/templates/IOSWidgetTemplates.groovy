...
class IOSWidgetTemplates extends WidgetTemplates { 
  ...
  def CommonWidgetTemplate = [
	...
	autoLayout: '[${parent} addConstraint: [NSLayoutConstraint constraintWithItem:${item1} attribute:${attribute1} relatedBy:${relation} toItem:${item2} attribute:${attribute2} multiplier:${multiplier} constant:${constant}]];',
...
''',
  ...
  def widgetTemplates = [
    ...
    ImageView: [
	  ...
	  set_file: '${name}.image = [UIImage imageNamed:${value}]',
    ],
    ...
    Button:  [
	  ...
	  autoCreate: '${name} = [UIButton buttonWithType:${arg0}];',	
