 ...
 *      Select 'Framework' section, search 'framework references'
 ...
 *   devbin/iosdocreader.sh -analyze
...
class IOSDocReader { 
  ...
  static api_base = 'https://developer.apple.com/library/ios/'
  ...
  static fetchLibs(args) { 
	...
	def page = readPage(new File(base + '/AllFrameworks-iOS7.html'))
