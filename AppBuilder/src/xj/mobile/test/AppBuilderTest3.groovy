...
class AppBuilderTest3 extends AppBuilderTest {  
  ...
  def iOSFileMap = [
    ...
    'app07b' : [ name: 'Countries 3', 
				 views: [ 'Top', 'List1' ] ], 
	'app07c' : [ name: 'European Countries 1',
				 views: [ 'Top', 'List1', 'CountryGermany', 'CountryPoland', 'CountryAustria', 'CountryGreece', 
						  'CountryPortugal', 'CountryBelgium', 'CountryHungary', 'CountryRomania', 'CountryBulgaria', 
						  'CountryIreland', 'CountrySlovakia', 'CountryCyprus', 'CountryItaly', 'CountrySlovenia', 
						  'CountryCzechrepublic', 'CountryLatvia', 'CountrySpain', 'CountryDenmark', 'CountryLithuania', 
						  'CountrySweden', 'CountryEstonia', 'CountryLuxembourg', 'CountryUnitedkingdom', 'CountryFinland', 
						  'CountryMalta', 'CountryFrance', 'CountryNetherlands' ] ],
	'app07ca' : [ name: 'European Countries',
				  views: [ 'Top', 'List1', 'Country' ] ],
	'app07d'  : [ name: 'UK France',
				  views: [ 'View1', 'Britain', 'France' ] ],
	'app07da' : [ name: 'UK France 2',
				  views: [ 'View1', 'Britain', 'France', 'Wiki' ] ],
  ...
  def androidFileMap = [
    ...
    'app07b' : [ name: 'Countries3', 
				 views: [ 'Countries3' ], 
				 layouts: [ 'main', 'list_header_list1', 'list_item_list1' ] ], 
	'app07c' : [ name: 'EuropeanCountries1',
				 views: [ 'EuropeanCountries1', 'CountryGermany', 'CountryPoland', 'CountryAustria', 'CountryGreece', 
						  'CountryPortugal', 'CountryBelgium', 'CountryHungary', 'CountryRomania', 'CountryBulgaria', 
						  'CountryIreland', 'CountrySlovakia', 'CountryCyprus', 'CountryItaly', 'CountrySlovenia', 
						  'CountryCzechrepublic', 'CountryLatvia', 'CountrySpain', 'CountryDenmark', 'CountryLithuania', 
						  'CountrySweden', 'CountryEstonia', 'CountryLuxembourg', 'CountryUnitedkingdom', 'CountryFinland', 
						  'CountryMalta', 'CountryFrance', 'CountryNetherlands' ],
				 layouts: [ 'main', 'list_item_list1', 'countryaustria', 'countrygreece', 'countryportugal', 
							'countrybelgium', 'countryhungary', 'countryromania', 'countrybulgaria', 'countryireland', 
							'countryslovakia', 'countrycyprus', 'countryitaly', 'countryslovenia', 'countryczechrepublic', 
							'countrylatvia', 'countryspain', 'countrydenmark', 'countrylithuania', 'countrysweden', 
							'countryestonia', 'countryluxembourg', 'countryunitedkingdom', 'countryfinland', 'countrymalta', 
							'countryfrance', 'countrynetherlands', 'countrygermany', 'countrypoland' ] ],
	'app07ca' : [ name: 'European Countries',
				  views: [ 'EuropeanCountries', 'Country', 'Utils' ],
				  layouts: [ 'main', 'list_item_list1' ] ], 
	'app07d'  : [ name: 'UK+France',
				  views: [ 'UKFrance', 'Britain', 'France' ],
				  layouts: [ 'main', 'britain', 'france' ] ],
	'app07da' : [ name: 'UK+France 2',
				  views: [ 'UKFrance2', 'Britain', 'France', 'Wiki' ],
				  layouts: [ 'main', 'britain', 'france', 'wiki' ] ],
  ...
  @Test(timeout=80000L)
  public void test07c_iOS() {
    test_iOS('app07c')
  }

  @Test(timeout=80000L)
  public void test07c_Android() {
    test_Android('app07c')
  }

  @Test(timeout=80000L)
  public void test07ca_iOS() {
    test_iOS('app07ca')
  }

  @Test(timeout=80000L)
  public void test07ca_Android() {
    test_Android('app07ca')
  }

  @Test(timeout=80000L)
  public void test07d_iOS() {
    test_iOS('app07d')
  }

  @Test(timeout=80000L)
  public void test07d_Android() {
    test_Android('app07d')
  }

  @Test(timeout=80000L)
  public void test07da_iOS() {
    test_iOS('app07da')
  }

  @Test(timeout=80000L)
  public void test07da_Android() {
    test_Android('app07da')
  }
