...
abstract class ViewPropertyExpression extends Expression {
  ...
  String platformViewType // the platform name of the widget 

  String attribute        // the name of the attribute   
  ClassNode attributeType // the type of the attribute 


  String parentView       // the id of the top view containing the widget, cu
                          // currently not used, preserved for future use 
